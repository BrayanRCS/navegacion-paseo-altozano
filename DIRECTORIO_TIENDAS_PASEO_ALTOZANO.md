# 🛍️ Directorio Completo de Establecimientos — Paseo Altozano

Este documento contiene la lista completa de tiendas, islas, locales comerciales y marcas de **Paseo Altozano**, organizada por nivel para la gestión de solicitudes y autorización de uso de logotipos oficiales dentro del sistema de navegación interactiva y señalética digital.

---

## 🏢 Nivel 1 — Planta Baja (Nivel Inferior)
...
## 🏬 Nivel 2 — Nivel Principal (Acceso Central & Tótem)
...
## 🍽️ Nivel 3 — Planta Alta (Restaurantes & Entretenimiento)
...
## 📝 Plantilla de Mensaje para Solicitud de Logotipos

```text
Asunto: Solicitud de logotipo oficial para sistema de señalética digital y navegación GPS — Paseo Altozano

Estimado equipo de [Nombre de la Marca / Gerencia de Marketing],

Espero que se encuentren muy bien.

Nos encontramos desarrollando e implementando el sistema oficial de señalética digital, tótem interactivo y navegación GPS para los visitantes de Paseo Altozano.

Este sistema permite a los miles de visitantes ubicar su tienda favorita en tiempo real, visualizar la ruta paso a paso desde su smartphone y conocer los locales del centro comercial de manera ágil e intuitiva.

Con el objetivo de representar a [Nombre de la Marca] de la manera más fiel, profesional y estética posible dentro del mapa interactivo, solicitamos amablemente su autorización para incorporar su logotipo oficial (en formato vectorial SVG o PNG transparente de alta resolución).

El uso del logotipo será estrictamente con fines de geolocalización y señalización dentro de la aplicación interactiva de la plaza.

Quedamos a su entera disposición si requieren una demostración del aplicativo o información complementaria.

Agradecemos de antemano su valioso apoyo y colaboración.

Atentamente,
[Tu Nombre / Cargo]
Proyecto de Navegación Interactiva — Paseo Altozano
[Teléfono / Correo de Contacto]
```

---

## 📐 Especificaciones Técnicas Recomendadas para los Logos

1. **Formato Preferido:** `.svg` (Vectorial escalable, peso ligero, máxima nitidez en cualquier nivel de zoom).
2. **Formato Alternativo:** `.png` con fondo transparente a resolución mínima de `512 x 512 px`.
3. **Variantes Útiles:**
   * Logotipo en color oficial.
   * Versión en blanco/monocromático para fondos oscuros.
