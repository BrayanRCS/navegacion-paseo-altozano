...
def build_master_dark_map(src_path, dest_path, level_num, scale_factor=3):
    print(f"Building Master Clean Dark Map for Level {level_num}: {src_path} -> {dest_path}...")
    ...
    # 2. Corridors Mask
    corridor_mask_orig = (gray >= 175) & (~bg_mask_orig) & (a > 30)
    ...
    for i in range(1, num_labels):
        ...
        # Filter out text logo glyphs (Chedraui, Liverpool, Sears text)
